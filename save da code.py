...
root.title("Do You want to play Ice Learning?")
...
button1 = Button(topFrame, text="Yes!", fg="Green", command=startgame)
button2 = Button(bottomFrame, text="No.", fg="Red", command=endgame)
...
while True:
    ...
    for enemy in enemies:
        if isCollision(player, enemy):
            ...
            over_pen.speed(0)
            over_pen.color("black")
            over_pen.penup()
            over_pen.setposition(-100, 0)
            over_pen.write(("Game Over"), align="left",
    ...
    directions_pen = turtle.Turtle()
    directions_pen.speed(0)
    directions_pen.color("Black")
    directions_pen.penup()
    directions_pen.setposition(0, 0)
    directions_pen.write(("Direcions:"), align="left", font=("Comic Sans MS", 14, "normal"))
